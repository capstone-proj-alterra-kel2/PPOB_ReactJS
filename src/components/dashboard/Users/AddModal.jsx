      ...
      <div className="w-[454px] flex flex-col">
        <div className="bg-grayScale-20 p-2 rounded">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col form-input mb-[24px] gap-3">
              <label className="text-grayScale-60 ">Nama Lengkap</label>
            ...
            <div className="flex flex-col form-input  mb-[24px] gap-3">
              <label className="text-grayScale-60">No Handphone</label>
              <div className="flex w-[100%] bg-grayScale-10 items-center pl-3">
                <img
                  src={ICONS.telpIcon}
                  alt="telp.icon"
